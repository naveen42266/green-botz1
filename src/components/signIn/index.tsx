...
const SignIn:React.FC<SignInProps> = ({handleSignIn,handleRouteToDashboard}) => {
    ...
    return(
        <div className="login-container flex flex-col items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4">
                ...
                <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={()=>handleSignIn(false)}>
                    SignUp
                </button>
            </form>
        </div>
